      ...
      <div className="flex flex-col border pb-1 rounded-md bg-white m-[20px] w-[500px] mt-[50px] items-center">
        ...
        <form className="p-5 flex flex-col w-full">
          <div className="gap-3 mb-6 flex flex-col w-full pt-4">
            <div>
                <p className=" text-gray-700 text-sm">Enter your email address and we will sent you an OTP to verify your account.</p>
            </div>
            <div>
              <label
                htmlFor="email"
          ...
          <div className="flex place-content-between items-center">
            <Link to= '/login' className="text-[#007bff] text-sm">
              Return to login
            </Link>
            <button
              type="submit"
