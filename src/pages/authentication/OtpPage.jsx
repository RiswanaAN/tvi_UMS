...
function OtpPage() {
  return (
    <div className="h-screen bg-[#007bff] border flex flex-col items-center">
      <div className="flex flex-col border pb-1 rounded-md bg-wte m-[20px] w-[500px] mt-[50px] items-center">
        ...
        <form className="p-5 flex flex-col w-full">
          <div className="gap-3 mb-6 flex flex-col w-full pt-4">
            <div>
                <p className=" text-gray-700 text-sm">Enter the OTP wch we send to your registered email.</p>
            </div>
            <div>
              <label
                htmlFor="otp"
              ...
              <input
                type="password"
                id="otp"
                className="bg-gray-50 border focus:outline-none border-gray-300 text-gray-900 rounded-md block w-full p-3 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-wte"
                placeholder="*******"
                required
              />
            </div>
